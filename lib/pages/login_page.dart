    ...
    return Scaffold(
        body: SingleChildScrollView(
          ...
          child: GestureDetector(
            onTap: () {
              //Toglie il focus dalle editText
                ...
                children: <Widget>[
                  Padding(
                    ...
                    child: Image(
                        ...
                        fit: BoxFit.fill,
                        image: const AssetImage('assets/img/quickplaylogo.PNG')),
                  ),
                  Padding(
        ...
        child: Row(
          ...
          children: <Widget>[
            Expanded(
              child: TextButton(
                style: ButtonStyle(
                  //Quando clicchi l'altro bottone, diventa trasparente questo.
                  overlayColor: MaterialStateProperty.all(Colors.transparent),
                ),
                //Click del bottone "Accedi"
